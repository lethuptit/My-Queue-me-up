...
import QueueHeader from './QueueInfo/QueueViewHeader';
...
import styles from './QueueInfo/QueueAdmin.module.scss';
import SidePanel from './QueueInfo/AdminSidePanel';
  ...
  return (
    <div className={styles['queue-view']}>
      ...
      <div className={styles['main-body']}>
        <TokenList className={styles['token-list-container']} queue={queue} />
        <SidePanel className={styles['side-admin-panel']}
          queueId={queueId} queueName={queueName} />
      </div>
    </div>
  );
};

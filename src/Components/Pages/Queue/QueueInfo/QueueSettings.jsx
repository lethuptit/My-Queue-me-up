...
export default ({ queueId }) => {
  ...
  const iconSetting = "bi bi-gear-fill";
  return (
    <>
      <SidePanelItem Icon={iconSetting} title="Queue Settings" 

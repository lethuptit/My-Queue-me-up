...
const handlePermission = (permission) => {
  ...
  console.log('Your browser has disabled notifications, please enable from Browser Settings')
...
export const disableNotifications = () => {
  ...
  console.log('Please disable notifications from your browser settings.')
};
